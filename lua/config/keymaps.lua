...
-- LaTeX
map("n", "<leader>lb", "<cmd>split | term cd %:p:h && pdflatex %:t && open -a Skim %:t:r.pdf<cr>", { desc = "LaTeX Build + Skim" })
...
map("n", "<leader>ds", function() Snacks.picker.lsp_symbols() end, { desc = "Document Symbols" })
